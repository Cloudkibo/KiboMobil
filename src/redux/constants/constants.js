...
export const UPDATE_WHATSAPP_MESSAGE_TEMPLATES = 'ActionTypes.UPDATE_WHATSAPP_MESSAGE_TEMPLATES'
...
export const LOAD_WHATSAPP_CONTACTS_LIST = 'LOAD_WHATSAPP_CONTACTS_LIST'
