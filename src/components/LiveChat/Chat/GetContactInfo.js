...
class GetContactInfo extends React.Component {
  ...
  updateText(text) {
    ...
    if (lines.length <= 3) {
      this.setState({ message: text, errorMessage: '' })
    }
  }
  ...
  render() {
    return (
      <Modal
        isVisible={this.props.showGetContactInfoModal}
        onBackdropPress={this.props.setGetContactInfoModal}
        style={{ margin: 0 }}
      >
            ...
            <Block style={{ backgroundColor: 'white', padding: 20, display: 'flex' }}>
              ...
              {this.state.query ? (
                <Block>
                  ...
                  <Text>
                    This will enable you to retrieve subscriber's {this.getCorrespondingCustomField().toLowerCase()} and
                    store it in a custom field: "{this.getCorrespondingCustomField()}".
                    {'\n\n'}
                  ...
                  {this.state.errorMessage ? (
                    <Text style={{ color: 'red', marginHorizontal: 10, position: 'relative', bottom: 5 }}>
                      {this.state.errorMessage}
                    </Text>
                  ) : (
                    []
                  ...
                  <Block style={styles.previewBlock}>
                    <Block style={styles.messageCardWrapper}>
                      <Block style={[styles.messageCard, styles.shadow]}>
                        <TextComponent linkColor='#5867dd' text={{ text: this.state.message }} />
                      </Block>
                    </Block>
